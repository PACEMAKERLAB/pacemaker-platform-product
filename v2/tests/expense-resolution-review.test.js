...
(function (global) {
    ...
    var result = global.PacemakerV2.Runtime.ExpenseResolutionReview.review({ expenseResolution: state.expenseResolutions[pendingIndex], decision: "approved", reviewedAt: "2026-08-07T17:00:00.000Z", reviewedBy: "USR-EXPERT-0001", reviewNote: "확인 완료", historyEventId: "HST-EXPENSE-TEST-001" });
