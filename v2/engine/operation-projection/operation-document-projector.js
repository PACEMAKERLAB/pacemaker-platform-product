...
return {documentRequirementId:requirement.documentRequirementId,documentType:requirement.documentType,title:requirement.title,status:stored==="attached"?"attached":round<=completed?"missing":"planned"};
});
